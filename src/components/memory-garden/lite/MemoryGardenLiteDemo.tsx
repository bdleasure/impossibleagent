...
import type { MemoryNode } from "./MemoryGardenLite";

/**
 * Memory Garden Lite Demo Component
 * 
 * A demonstration component for the Memory Garden Lite with sample data
...
export function MemoryGardenLiteDemo() {
  ...
  return (
    <div className="memory-garden-lite-demo">
      <h2 className="text-2xl font-bold mb-6">Memory Garden Lite</h2>
      ...
      <div className="mt-8 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
        <h3 className="text-lg font-semibold mb-3">About Memory Garden Lite</h3>
        <p className="mb-2">
          Memory Garden Lite is a 2D visualization of memories and tasks using SVG and Canvas.
          It provides an intuitive way to explore and interact with your memories and tasks.
        </p>
        <p>
          Features include interactive nodes, seasonal themes, natural gestures for navigation,
          and detailed information panels for each memory or task.
        </p>
      </div>
    </div>
  );
